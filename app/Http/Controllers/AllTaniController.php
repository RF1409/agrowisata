...
class AllTaniController extends Controller
{
    ...
    {
        return view('dashboard.alltanis.index', [
            'alltanis' =>Tani::all()
        ]) ;
    }
    ...
    {
        return view('dashboard.alltanis.show', [
            'alltani' => $alltani
        ]);
    ...
    {
        Tani::destroy($alltani->id);

        return redirect('/dashboard/alltanis')->with('success', 'Data Berhasil Di Hapus!');
    }
}
