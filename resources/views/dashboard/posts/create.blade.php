      ...
      <div class="col-12">
        <div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2bs4" name="catagory_id" style="width: 100%;">
                ...
                @foreach ($catagories as $catagory)
                  ...
                  @if(old('catagory_id') == $catagory->id)
            ...
            <button type="submit" class="btn btn-primary"><i class="bi bi-box-arrow-up"></i> Create Post</button>
          
            <a href="/dashboard/posts" class="btn btn-success"><i class="bi bi-box-arrow-in-left"></i> Back to all Post</a>
            </form>
